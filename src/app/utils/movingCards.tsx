...
export const PositiveStockCard = ({ ticker, open, close, vol, changePercent }: StockCardProps) => (
  <article className="flex items-end justify-between rounded-lg border border-gray-100 bg-white p-6 dark:border-gray-800 dark:bg-gray-900 min-w-[250px]">
    <div>
      ...
      <p className="text-xs text-gray-400 dark:text-gray-500">Open: ${open.toFixed(2)}</p>
      <p className="text-xs text-gray-400 dark:text-gray-500">Vol: {vol.toLocaleString()}</p>
    </div>
